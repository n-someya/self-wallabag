...
# Configuration
PROJECT_ID="plucky-vault-184315"
REGION="us-central1"
...
supabase_project_ref      = "ggqgjhxtbwvdodanabgc"
supabase_host             = "db.ggqgjhxtbwvdodanabgc.supabase.co"
supabase_port             = 5432
...
env_vars = {
  "WALLABAG_DATABASE_HOST"     = "db.ggqgjhxtbwvdodanabgc.supabase.co"
